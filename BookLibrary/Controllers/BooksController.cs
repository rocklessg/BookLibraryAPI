...
namespace BookLibrary.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public BooksController(IBookLibraryGenericQuery<Book> bookQueryCommand, ILogger<BooksController> logger, IMapper mapper)
        {
        ...
        public async Task<IActionResult> AddNewBookToBookLibraryAsync([FromBody] BookRequestDTO bookDto)
        {
            ...
            {
                _logger.LogError($"Invalid POST attemp in {nameof(AddNewBookToBookLibraryAsync)}");
